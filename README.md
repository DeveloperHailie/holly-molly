## 목차
 NO | 제목 |  
---- | ----
 1 | [프로젝트 소개](#ghost-프로젝트-소개-ghost)| 
 2 | [게임 이용 방법](#게임-이용-방법) |
 3 | [팀원 소개](#woman_technologist-팀원) |
 4 | [아키텍쳐](#아키텍쳐) |
 5 | [기술 스택](#hammer_and_wrench-기술-스택) |
 6 | [API 문서 (서버)](#wiki) |
 7 | [주요 기능](#star2-주요-기능) |
 8 | [개발 기간](#개발-기간) |
 9 | [변경된 시스템(서버) 구성도](#변경된-시스템서버-구성도) |
...
## 변경된 시스템(서버) 구성도
지연 현상 해결 위해 pm2 cluster mode로 실행 ($pm2 start app.js -i max) <br />
메모리 등의 자원 공유하지 못하므로 Map, Timer, Resolve 이용하는 실시간 투표 기능 이용 불가 <br />
➡ 해결 위해 아래 사진과 같이 수정 <br />
